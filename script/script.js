...
function populatePrefixData() {
    ...
    addPrefixData([453039, 453038, 453037, 453036, 453035, 453096, 453097, 453098, 453099, 453226, 453306, 453326, 453220, 453040, 453323, 453222, 453223, 453016, 453286, 453224, 453229, 453288, 453324, 453227, 453197, 453225, 452221, 453228, 454104, 453284, 453322], { sbc: "sbcproc01", code: "41135", area: "CSC", description: "Rota CLIENTE", city: "Cascavel", ddd: "452", sbcCode: "55216", type: "190" });
    ...
    addPrefixData([443280, 443514, 443642, 443911, 442036, 443149, 443683, 443638, 443648, 443583], { sbc: "sbcproc01", code: "41054", area: "ASD", description: "Rota CLIENTE", city: "Assis Chateaubriand", ddd: "449", sbcCode: "55216", type: "190" });
    ...
    addPrefixData([413797, 413552, 413607, 413643, 413031, 413604, 413608, 413406, 413150, 413550, 413354, 413276, 413232, 413092, 413349, 413372, 413246, 413537, 413516], { sbc: "sbcproc01", code: "41000", area: "CTA", description: "Rota CLIENTE", city: "Curitiba", ddd: "412", sbcCode: "55216", type: "190" });
    addPrefixData([413531, 412208, 413627, 413688, 413161, 413060, 413070, 413107, 413113, 413116, 413192, 413795, 413798, 413810], { sbc: "sbcproc01", code: "41919", area: "FZR", description: "Rota CLIENTE", city: "Fazenda Rio Grande", ddd: "412", sbcCode: "55216", type: "190" });
    addPrefixData([412204, 413614, 413641, 413642, 413681, 413133, 413043, 413048, 413106, 413109, 413126, 413127, 412094, 414114], { sbc: "sbcproc01", code: "41049", area: "AUC", description: "Rota CLIENTE", city: "Araucaria", ddd: "412", sbcCode: "55216", type: "190" });
    addPrefixData([412207, 413589, 413590, 413673, 413137, 413034, 413057, 413102, 413108, 413144, 413145, 413191, 414122], { sbc: "sbcproc01", code: "41495", area: "PQA", description: "Rota CLIENTE", city: "Piraquara", ddd: "412", sbcCode: "55216", type: "190" });
}
...
function gerarPlanoDeDiscagem(terminais) {
    ...
    terminais.forEach(function (terminal) {
        ...
        csvPlanoDeDisc += "\n";
        csvPlanoDeDisc += "^0(14|21|31|41|43|15|12|25|99)" + terminal + "$";
        csvPlanoDeDisc += ";" + "3";
        csvPlanoDeDisc += ";;" + "10";
